...
namespace Yumi
{
    ...
    SharedPtr<SubTexture2D> SubTexture2D::Create(const AssetLink<Texture2D>& parentTexture, const Vector2& locationInAtlas, const Vector2& size)
    {
        return CreateSharedPtr<SubTexture2D>(parentTexture, locationInAtlas, size);
    }
    ...
    SubTexture2D::SubTexture2D(const AssetLink<Texture2D>& parentTexture, const Vector2& locationInAtlas, const Vector2& size)
        : m_ParentTexture(parentTexture)
        , m_Size(size)
    {
